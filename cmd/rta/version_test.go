...
func TestVersionFrom(t *testing.T) {
	cases := []struct {
		...
		{"go install of a tag", "dev", "v0.23.0", "v0.23.0"},
		{"go install of a branch keeps the pseudo-version", "dev", "v0.23.1-0.20260920101010-85eb672c1d2e", "v0.23.1-0.20260920101010-85eb672c1d2e"},
