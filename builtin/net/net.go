		...
		Capabilities: []plugin.Capability{
			...
			},
			{
				...
				Inputs: []plugin.Field{
					...
					{Name: "timeout", Type: plugin.Int, Config: "timeout", Default: 2, Min: 1, Max: 60, Help: "per-probe timeout in seconds"},
					{Name: "resolve", Type: plugin.Bool, Config: "trace.resolve", Default: true, Help: "reverse-resolve hop addresses to names"},
				},
				Run: runTrace,
			},
			{
			...
			},
			{
				...
				Inputs: []plugin.Field{
					...
					{Name: "timeout", Type: plugin.Int, Config: "timeout", Default: 2, Min: 1, Max: 60, Help: "per-port timeout in seconds"},
				},
				Run: runPort,
			},
			{
