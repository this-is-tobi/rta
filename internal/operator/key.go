...
// trail, not a permission set. docs/30-boundary/50-team-policy.md refuses subjects
// and allow rules with an argument that applies here unchanged; the day a read-only
